...
class Deals extends React.Component {
    constructor(props) {
        super(props);
        const deals = [
            {id:0, name: 'yurun new deals', product: {name:'mask',price: 1, description:'medial mask'}, amount: 1000, stage:'Appointment Scheduled',
            discount: 1, total: 2000,closeDate:'30-10-2020', contact: null, company: null},
             {id:1, name: 'yurun new deals', product: {name:'mask',price: 1, description:'medial mask'}, amount: 2000, stage:'Appointment Scheduled',
             discount: 1, total: 2000, closeDate:'30-11-2020', contact: null, company: null}
        ]
        this.state = {
            disabled: false,
            deals: deals,
